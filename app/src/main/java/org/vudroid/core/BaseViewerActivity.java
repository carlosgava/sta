...
public abstract class BaseViewerActivity extends Activity implements DecodingProgressListener, CurrentPageListener
{
    ...
    {
        String name = getIntent().getData().getLastPathSegment();
        
        int index = name.indexOf("val_");
...
//        final MenuItem menuItem = menu.add(1, MENU_FULL_SCREEN, 0, "Full screen").setCheckable(true).setChecked(viewerPreferences.isFullScreen());
